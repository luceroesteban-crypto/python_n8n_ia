...
from config import DATABASE, USER, PASS, HOST, PORT

# 1. Configuración de la base de datos
Base = declarative_base() # Clase base para las tablas
# Engine para la conexión
engine = create_engine(f'mysql+mysqlconnector://{USER}:{PASS}@{HOST}:{PORT}/{DATABASE}')
