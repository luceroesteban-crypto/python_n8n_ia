# ============================================================
# EJEMPLO 09: Varias URLs para una misma función + 2 páginas
# ------------------------------------------------------------
# Una función puede responder a más de una ruta apilando varios
# @app.route. Además mostramos cómo navegar entre páginas.
# ============================================================
...
# Esta función responde TANTO a '/' como a '/inicio'.
